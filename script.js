// js/main.js
// Punto de entrada optimizado para ASFIGES
...
const initAnimations = () => {
  ...
  gsap.fromTo('.hero-subcopy', { opacity: 0, y: 20 }, {
...
const initHeroScene = async () => {
  ...
  const { WebGLRenderer, Scene, PerspectiveCamera, Points, BufferGeometry, BufferAttribute, ShaderMaterial, AdditiveBlending, Vector3, Color, Clock } = THREE;
  ...
  const particleCount = window.innerWidth < 768 ? 8000 : 20000;
